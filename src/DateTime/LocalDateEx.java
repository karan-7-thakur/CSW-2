...
public class LocalDateEx {
    public static void main(String[] args) {
        ...
        System.out.println(obj.plusDays(5)); // doesn't change the original object but returns a new object with new
                                             // date
        ...
        System.out.println(obj.format(format)); // fomrat method takes Instance of DateTimeFormatter. Wont chnage the
                                                // original date
