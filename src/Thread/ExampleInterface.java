    ...
    public static void main(String[] args) {
        ...
        Runnable obj = () -> {
            ...
            for (int i = 0; i < 10000; i++) {
                ...
                // System.out.println("This is " + Thread.currentThread().getName()+" "+inter.count);
               // count++; // cannot use the variable inside the runnable object. if re-instantiating after this object, then its value will be final
               inter.increaseCount();
